...
export const getButtonColor = (color, isOutlined, hasHover, isActive = false) => {
  const colors = {
    ring: {
      ...
      info: 'ring-blue-300 dark:ring-[#103029]'
    },
    active: {
      white: 'bg-gray-100',
    ...
    bg: {
      ...
      info: 'bg-[#133213] dark:bg-blue-500 text-white'
    },
    bgHover: {
      ...
      info: 'hover:bg-[#103029] hover:border-[#103029] hover:dark:bg-[#133213] hover:dark:border-[#133213]'
    },
    borders: {
      white: 'border-white',
      ...
      info: 'border-[#133213] dark:border-blue-500'
    },
    text: {
      ...
      info: 'text-[#133213] dark:text-blue-500'
    },
    outlineHover: {
      contrast:
      ...
      info: 'hover:bg-[#133213] hover:text-white hover:dark:text-white hover:dark:border-[#133213]'
    }
  }
